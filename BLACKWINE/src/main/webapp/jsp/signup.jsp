...
<head>
<meta charset="UTF-8">
<title>BLACKWINE | Create Account</title>
...
<div class="signup-card">
    ...
    <p>Join BLACKWINE today</p>

    <div class="input-group">
        <input type="text" id="name" required placeholder=" " name="fullname">
...
function signup(){
    ...
    if(name==="" || user==="" || email==="" || pass==="" || confirm===""){
        ...
        window.location.href = "jsp/login.html"; // ð linked to login
    }
}
</script>
</form>
